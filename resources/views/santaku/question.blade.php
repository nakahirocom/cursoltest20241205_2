            ...
            <div class="flex">
                ...
                <div>
                    <button type="button" value="{{ $question_a->answer }}" id="{{ $question_a->id }}"
                        ...
                        class="sentaku rounded-md px-3.5 py-2 m-1 overflow-hidden relative group cursor-pointer border-2 font-medium border-indigo-600 text-indigo-600 text-white">
                        <span
